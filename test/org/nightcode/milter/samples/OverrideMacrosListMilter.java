...
public final class OverrideMacrosListMilter {
  ...
  public static void main(String[] args) throws ExecutionException, InterruptedException, TimeoutException {
    ...
    // a simple milter handler that override the list of macros
    MilterHandler milterHandler = new OverrideMacrosListMilterHandler(milterActions, milterProtocolSteps, milterMacros);
